...
<body <?php body_class(); ?>>
    <div class="container navbar-static-top utilitynav visible-desktop">
        <div class="span6 newsletter">Follow us as we grow&nbsp;&nbsp;<input type="text" placeholder="ENTER YOUR EMAIL ADDRESS"></div><div class="span3 donate"><a href="<?php bloginfo('url'); ?>/?page_id=23">Donate Now</a></div><div class="span3 news"><a href="<?php bloginfo('url'); ?>/?cat=13">Latest News</a></div>
    </div>
